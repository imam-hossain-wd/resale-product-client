    ...
    return (
        <section>
            ...
            <div className='flex justify-around text-center'>
                <div className='border-4 rounded  w-64 h-72 p-3' style={{borderColor:"#49C1FE"}}>
                ...
                <div className='border-4 rounded  w-64 h-72 p-3' style={{borderColor:'#49D7F4'}}>
                   <div className='flex justify-center'>
                   <img src={"icon1.jpg"} className="w-20 h-20 m-2" alt="" /> 
                   </div>
                ...
                <div className='border-4 rounded   w-64 h-72 p-3' style={{borderColor:"#E56773"}}>
                   <div className='flex justify-center'>
                   <img src={"icon1.jpg"} className="w-20 h-20 m-2" alt="" /> 
                   </div>
                ...
                <div className='border-4 rounded  w-64 h-72 p-3' style={{borderColor:"#52A57F"}}>
                   <div className='flex justify-center'>
                   <img src={"icon1.jpg"} className="w-20 h-20 m-2" alt="" /> 
                   </div>
